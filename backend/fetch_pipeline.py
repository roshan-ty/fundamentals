...
def run_pipeline() -> dict[str, Any]:
    ...
    write_json("master_bias.json", {
        ...
        "score_breakdowns": scoring_results.get("score_breakdowns", {}),
        "analysis_window_days": scoring_results.get("analysis_window_days", 14),
        "analysis_note": scoring_results.get("analysis_note", ""),
